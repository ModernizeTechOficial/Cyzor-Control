...
--> statement-breakpoint
CREATE INDEX `clients_ws_idx` ON `clients` (`workspace_id`);--> statement-breakpoint
...
CREATE INDEX `deploys_prod_idx` ON `deploys` (`product_id`);--> statement-breakpoint
ALTER TABLE `workspace_members` ADD `cargo` text DEFAULT 'Colaborador';