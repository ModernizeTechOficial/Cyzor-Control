...
export default function LoginView({ onLogin }: { onLogin: () => void }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#FAFAFA] font-sans">
      <div className="bg-[#FFFFFF] p-10 rounded-[30px] border border-[#0F172A0F] shadow-[0_8px_40px_rgba(0,0,0,0.04)] w-full max-w-[440px] flex flex-col items-center relative overflow-hidden">
        
        {/* Subtle Tech Pattern */}
        <div className="absolute top-0 w-full h-1 bg-gradient-to-r from-transparent via-[#111111]/20 to-transparent"></div>

        <div className="w-14 h-14 rounded-2xl bg-[#111111] flex items-center justify-center mb-6 shadow-[0_4px_12px_rgba(0,0,0,0.15)]">
          {/* CYZOR Monogram */}
        ...
        <div className="text-center mb-8 w-full">
          <h2 className="text-3xl font-display font-bold text-[#111111] tracking-tight mb-2">
        ...
        {errorMsg && (
          <div className="w-full bg-red-50 border border-red-100 text-red-600 text-xs font-bold px-4 py-3.5 rounded-[16px] mb-6 animate-in fade-in duration-200">
            {errorMsg}
          </div>
        )}
        ...
        <button 
          ...
          className="text-xs font-bold text-[#64748B] hover:text-[#111111] mt-8 hover:underline transition-colors block"
        >
