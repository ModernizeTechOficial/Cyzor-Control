...
export default function StrategicPriorityCard({
  ...
  return (
    <motion.div 
      ...
      className="w-full bg-white border border-[#0F172A08] rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.015)] p-6 sm:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 overflow-hidden relative"
    >
      ...
      <div className="flex-1 space-y-4 max-w-3xl">
        ...
        <div className="flex items-center gap-2 pt-1">
          <span className="text-xs font-semibold text-[#64748B]">Impacto esperado no negócio:</span>
      ...
      <div className="flex flex-col sm:flex-row md:flex-col gap-3 w-full sm:w-auto shrink-0 md:items-end z-10">
        <button
          onClick={() => setCurrentView(priority.view)}
          className="w-full sm:w-auto bg-[#111111] hover:bg-blue-600 text-white px-5 py-3 rounded-xl font-bold text-xs transition-all flex items-center justify-center gap-2 group shadow-sm hover:shadow-md"
        >
          Executar Ação
        ...
        <button
          ...
          className="w-full sm:w-auto text-[#64748B] hover:text-[#111111] font-bold text-xs transition-all flex items-center justify-center gap-1.5 py-2.5 px-3 hover:bg-slate-50 rounded-xl border border-transparent hover:border-slate-100/50"
        >
