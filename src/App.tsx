...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] font-sans relative">
      ...
      {!isSidebarCollapsed && (
        <div 
          className="fixed inset-0 bg-[#111111]/20 backdrop-blur-sm z-30 lg:hidden block" 
          onClick={() => setIsSidebarCollapsed(true)} 
        />
      )}

      <div className={`transition-all duration-300 ${isSidebarCollapsed ? 'lg:ml-[88px]' : 'lg:ml-[280px]'} w-full lg:w-auto flex-1`}>
